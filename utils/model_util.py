...
from model.tric_motion import TriCMotion
...
def create_model_and_diffusion(args, data, is_training=False):
    model = TriCMotion(**get_model_args(args, data), is_training=is_training)
