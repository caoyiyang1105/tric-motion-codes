...
def add_model_options(parser):
    ...
    group.add_argument("--arch", default='tri_domain',
                       choices=['trans_enc', 'trans_dec', 'gru', 'tri_domain'], type=str,
                       help="Architecture types as reported in the paper.")
    group.add_argument("--causal", default=True, type=bool, help="If true, will use CCMD during training.")
    group.add_argument("--ds_ratio", default=4, type=int, help="Down-sampling ratio.")
    group.add_argument("--text_encoder_type", default='bert',
    ...
    group.add_argument("--lambda_causal", default=1.0, type=float, help="Causal loss.")
    group.add_argument("--lambda_percep", default=10.0, type=float, help="Perceptual loss.")
...
def add_training_options(parser):
    ...
    group.add_argument("--num_steps", default=900000, type=int,
    ...
    group.add_argument("--gen_guidance_param", default=4.0, type=float,
...
def add_sampling_options(parser):
    ...
    group.add_argument("--num_samples", default=2, type=int,
                       help="Maximal number of prompts to sample, "
                            "if loading dataset from file, this field will be ignored.")
    group.add_argument("--num_repetitions", default=2, type=int,
                       help="Number of repetitions, per sample (text prompt/action)")
    group.add_argument("--guidance_param", default=4.0, type=float,
                       help="For classifier-free sampling - specifies the s parameter, as defined in the paper.")
